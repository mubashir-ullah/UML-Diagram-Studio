            ...
            {post.sections ? (
              post.sections.map((section, index) => {
                ...
                const renderInlineMarkdown = (text: string) => {
                  ...
                  // Match bold text **text** or code `code`
                  const regex = /(\*\*([^*]+)\*\*|`([^`]+)`)/g;
                  let match;
